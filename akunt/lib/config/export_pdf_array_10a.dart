        ...
        children: [
              ...
              for (int i = 0; i < isi_data.length; i++)
                pw.TableRow(
                  children: [
                    ...
                    pw.Expanded(
                      flex: 2,
                      child: pw.Text(sapi.format(isi_data[i]['g']).toString(),
                          textAlign: pw.TextAlign.right,
                          style: pw.TextStyle(fontSize: 8)),
                    ),
                    pw.Expanded(
                    ...
                    pw.Expanded(
                      flex: 4,
                      child: pw.Text(sapi.format(isi_data[i]['i']).toString(),
                          textAlign: pw.TextAlign.right,
                          style: pw.TextStyle(fontSize: 8)),
                    ),
                    pw.Expanded(
                      flex: 3,
                      child: pw.Text(isi_data[i]['j'].toString(),
                          textAlign: pw.TextAlign.center,
                          style: pw.TextStyle(fontSize: 8)),
                    ),
                  ],
          ...
          pw.Padding(
            ...
            child: pw.Row(children: [
              ...
              pw.Expanded(
                flex: 3,
                child: pw.Text(isi_data[0]['k'].toString(),
                    textAlign: pw.TextAlign.right,
                    style: pw.TextStyle(
                        fontWeight: pw.FontWeight.bold, fontSize: 8)),
              ),
              pw.Expanded(
                flex: 4,
                child: pw.Text(sapi.format(isi_data[0]['l']).toString(),
                    textAlign: pw.TextAlign.right,
                    style: pw.TextStyle(
                        fontWeight: pw.FontWeight.bold, fontSize: 8)),
              ),
