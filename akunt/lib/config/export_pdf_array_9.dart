              ...
              children: [
                    ...
                    for (int i = 0; i < isi_data.length; i++)
                      pw.TableRow(
                        children: [
                          ...
                          pw.Expanded(
                            flex: 2,
                            child: pw.Text(isi_data[i]['i'].toString(),
                                style: pw.TextStyle(fontSize: 8),
                                textAlign: pw.TextAlign.right),
                          ),
                        ],
                ...
                pw.Padding(
                  ...
                  child: pw.Row(children: [
                    ...
                    pw.Expanded(
                      flex: 2,
                      child: pw.Text(isi_data[0]['t_aw'].toString(),
                          style: pw.TextStyle(
                              fontWeight: pw.FontWeight.bold, fontSize: 8),
                          textAlign: pw.TextAlign.right),
                    ),
                    pw.Expanded(
                      flex: 2,
                      child: pw.Text(isi_data[0]['t_ma'].toString(),
                          style: pw.TextStyle(
                              fontWeight: pw.FontWeight.bold, fontSize: 8),
                          textAlign: pw.TextAlign.right),
                    ),
                    pw.Expanded(
                      flex: 2,
                      child: pw.Text(isi_data[0]['t_ke'].toString(),
                          style: pw.TextStyle(
                              fontWeight: pw.FontWeight.bold, fontSize: 8),
                          textAlign: pw.TextAlign.right),
                    ),
                    pw.Expanded(
                      flex: 2,
                      child: pw.Text(isi_data[0]['t_sd'].toString(),
                          style: pw.TextStyle(
                              fontWeight: pw.FontWeight.bold, fontSize: 8),
                          textAlign: pw.TextAlign.right),
                    ),
                ...
                pw.Center(
                  child: pw.Padding(
                      padding:
                          pw.EdgeInsets.symmetric(horizontal: 16, vertical: 1),
                      child: pw.Divider(
                        height: 1,
                        thickness: 1,
                      )),
