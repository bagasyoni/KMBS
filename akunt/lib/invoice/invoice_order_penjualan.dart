          ...
          children: [
                  ...
                  pw.Expanded(
                    ...
                    child: pw.Container(
                      child: pw.Padding(
                        ...
                        child: pw.Text(
                          "Sales : " + data_transaksi["sales"].toString(),
            ...
            pw.Container(
              child: pw.Padding(
                padding: pw.EdgeInsets.only(left: 16, top: 4),
                child: pw.Text(
                  "Kepada YTH : " + data_transaksi["customer"].toString(),
                  style: pw.TextStyle(
                    fontSize: 12,
                  ),
                ),
                      ...
                      pw.Expanded(
                        ...
                        child: pw.Text(
                            config().format_rupiah(
                                detail_transaksi[i]["harga_so"].toString()),
                            textAlign: pw.TextAlign.right,
                            style: pw.TextStyle(fontSize: 12)),
                      ),
                      pw.Expanded(
                ...
                child: pw.Row(
                    ...
                    children: [
                      ...
                      pw.SizedBox(
                        ...
                        child: pw.Text(
                          config().format_rupiah(
                              (data_transaksi["total_so"]).toString()),
                          textAlign: pw.TextAlign.right,
                          style: pw.TextStyle(
                            fontSize: 12,
                          ),
