...
import '../model/model_lapbelibahan.dart';

class LapBelibahanController with ChangeNotifier {
  final Future<SharedPreferences> _prefs = SharedPreferences.getInstance();
  SharedPreferences prefs;
  model_lapbelibahan m_lapbelibahan = model_lapbelibahan();
  ...
  Future<void> proses_export_lapbelibahan(int mode) async {
    if (data_list.length > 0) {
      ...
      String judul = "Laporan Pembelian Bahan";
      String header_title = "";
      if (mode == 0) {
