...
import '../model/model_lapkartu_hut.dart';
import '../model/model_periode.dart';

class LapKartuhutController with ChangeNotifier {
  final Future<SharedPreferences> _prefs = SharedPreferences.getInstance();
  SharedPreferences prefs;
  model_lapkartu_hut m_lapkartu_hut = model_lapkartu_hut();
  ...
  double keluar = 0;
  double saldo = 0;
  List<DropdownMenuItem<String>> dropdown_supplier;
  ...
  Future<void> select_data() async {
    ...
    data_list = await m_lapkartu_hut.data_lap(
  ...
  Future<void> proses_export_lapkartuhut(int mode) async {
    if (data_list.length > 0) {
      ...
      String judul = "Laporan Kartu Hutang";
      String header_title = "";
      if (mode == 0) {
