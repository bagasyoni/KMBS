...
// class DragonbeliController with ChangeNotifier {
...
//     data_beli_list = await m_order.select_dragonbeli(
...
//       for (int i = 0; i < data_beli_list.length; i++) {
//         Map<String, dynamic> isi_map = new Map<String, dynamic>();
//         isi_map['a'] = data_beli_list[i]['tanggal'];
//         isi_map['b'] = data_beli_list[i]['no_bukti'];
//         isi_map['c'] = data_beli_list[i]['sales'];
//         isi_map['d'] = data_beli_list[i]['customer'];
//         isi_map['e'] = data_beli_list[i]['keterangan'];
//         isi_map['f'] = data_beli_list[i]['total_qty'];
//         isi_map['g'] = data_beli_list[i]['total_so'];
//         if (data_beli_list[i]['status'] == 1) {
//           isi_map['h'] = "Diterima";
//         } else {
...
//       map_transaksi['a'] = data_beli_list[index_terpilih]['tanggal'];
//       map_transaksi['b'] = data_beli_list[index_terpilih]['no_bukti'];
//       map_transaksi['c'] = data_beli_list[index_terpilih]['sales'];
//       map_transaksi['d'] = data_beli_list[index_terpilih]['customer'];
//       map_transaksi['e'] =
//           data_beli_list[index_terpilih]['keterangan'];
//       if (data_beli_list[index_terpilih]['status'] == 1) {
...
//           data_beli_list[index_terpilih]['no_bukti'],
//           "NO_BUKTI",
//           "kas");
...
//       footer_excel.add(data_beli_list[index_terpilih]['total_qty']);
//       footer_excel.add("Total");
//       footer_excel.add(data_beli_list[index_terpilih]['total_so']);
//       String judul =
//           "Invoice Order Penjualan (${data_beli_list[index_terpilih]['no_bukti']})";
...
//     List data_account = await m_order.select_po_detail(
//         data_beli_list[index_terpilih]['no_bukti'], "NO_BUKTI", "po");
//     InvoiceOrderPenjualan()
//         .proses_print(data_beli_list[index_terpilih], data_account);
//   }
...
//   String tanggal;
//   List<DataPo> data_brg_keranjang = List<DataPo>();
//   double sumQty = 0;
//   double sumTotal = 0;
//   String uraian, reff;
//   int no_urut = 0;
//   List<DataPo> brgList = List<DataPo>();
//   bool status_kasmasuk = true;

//   Future<void> initData_addBeli() async {
//     data_brg_keranjang = new List<DataPo>();
...
//       }
//     });
//     await model_po().cari_po("").then((value) {
//       if (value != null) {
//         brgList.clear();
//         for (int i = 0; i < value.length; i++) {
//           brgList.add(DataPo.fromJson(value[i]));
//         }
//       }
//     });
//   }
...
//     }
//     hitungSubTotal();
//     await model_po().cari_barang("").then((value) {
//       if (value != null) {
//         brgList.clear();
//         for (int i = 0; i < value.length; i++) {
//           brgList.add(DataPo.fromJson(value[i]));
...
//   void addKeranjang(DataPo mAccount) {
