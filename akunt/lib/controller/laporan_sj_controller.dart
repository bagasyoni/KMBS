...
import '../model/model_lapsj.dart';

class LapSjController with ChangeNotifier {
  final Future<SharedPreferences> _prefs = SharedPreferences.getInstance();
  SharedPreferences prefs;
  model_lapsj m_lapbelibahan = model_lapsj();
  ...
  Future<void> proses_export_lapsj(int mode) async {
    if (data_list.length > 0) {
      ...
      String judul = "Laporan Surat Jalan";
      String header_title = "";
      if (mode == 0) {
