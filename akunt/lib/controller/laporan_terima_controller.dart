...
import '../model/model_lapterima.dart';

class LapTerimaController with ChangeNotifier {
  final Future<SharedPreferences> _prefs = SharedPreferences.getInstance();
  SharedPreferences prefs;
  model_lapterima m_lapterima = model_lapterima();
  ...
  Future<void> select_data() async {
    data_list = await m_lapterima.data_lap(tanggal_awal, tanggal_akhir);
    total = 0;
    qty = 0;
  ...
  Future<void> proses_export_lapterima(int mode) async {
    if (data_list.length > 0) {
      ...
      String judul = "Laporan Penerimaan";
      String header_title = "";
      if (mode == 0) {
