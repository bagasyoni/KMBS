...
import '../model/model_lappobahanlokal.dart';

class LapPobahanlokalController with ChangeNotifier {
  final Future<SharedPreferences> _prefs = SharedPreferences.getInstance();
  SharedPreferences prefs;
  model_lappobahanlokal m_lappobahanlokal = model_lappobahanlokal();
  ...
  Future<void> select_data() async {
    data_list = await m_lappobahanlokal.data_lap(
        tanggal_awal,
        tanggal_akhir,
        sup1Controller.text,
        sup2Controller.text,
