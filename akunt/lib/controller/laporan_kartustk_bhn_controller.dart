...
import '../model/model_lapkartustk_bhn.dart';
import '../model/model_periode.dart';

class LapKartustkbhnController with ChangeNotifier {
  final Future<SharedPreferences> _prefs = SharedPreferences.getInstance();
  SharedPreferences prefs;
  model_lapkartustk_bhn m_lapkartustk_bhn = model_lapkartustk_bhn();
  ...
  Future<void> select_data() async {
    ...
    data_list = await m_lapkartustk_bhn.data_lap(
  ...
  Future<void> proses_export_lapkartustkbhn(int mode) async {
    if (data_list.length > 0) {
      ...
      String judul = "Laporan Kartu Stok Bahan";
      String header_title = "";
      if (mode == 0) {
