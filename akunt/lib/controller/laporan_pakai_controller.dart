...
import '../model/model_lappakai.dart';

class LapPakaiController with ChangeNotifier {
  final Future<SharedPreferences> _prefs = SharedPreferences.getInstance();
  SharedPreferences prefs;
  model_lappakai m_lapbelibahan = model_lappakai();
  ...
  Future<void> proses_export_lappakai(int mode) async {
    if (data_list.length > 0) {
      ...
      String judul = "Laporan Pemakaian";
      String header_title = "";
      if (mode == 0) {
