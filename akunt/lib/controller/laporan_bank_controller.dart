...
import '../model/model_lapbank.dart';

class LapBankController with ChangeNotifier {
  model_lapbank m_lapbank = model_lapbank();
  ...
  Future<void> select_data() async {
    data_list = await m_lapbank.data_lap(tanggal_awal, tanggal_akhir);
    notifyListeners();
  }
  ...
  Future<void> proses_export_lapbank(int mode) async {
    if (data_list.length > 0) {
      ...
      String judul = "Laporan Bank Masuk Keluar";
      String header_title = "";
      if (mode == 0) {
