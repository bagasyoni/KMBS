...
import '../config/export_pdf_array_2.dart';
import '../model/model_lap_nera.dart';
import '../model/model_periode.dart';

class LapNeraController with ChangeNotifier {
  final Future<SharedPreferences> _prefs = SharedPreferences.getInstance();
  SharedPreferences prefs;
  model_lap_nera m_lap_nera = model_lap_nera();
  ...
  Future<void> select_data() async {
    ...
    data_list = await m_lap_nera.data_lap(filterpermodal);
    jum = 0;
