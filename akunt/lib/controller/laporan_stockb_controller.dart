...
import '../model/model_lapstockb.dart';

class LapStockbController with ChangeNotifier {
  final Future<SharedPreferences> _prefs = SharedPreferences.getInstance();
  SharedPreferences prefs;
  model_lapstockb m_lapstockb = model_lapstockb();
  ...
  Future<void> select_data() async {
    data_list = await m_lapstockb.data_lap(tanggal_awal, tanggal_akhir);
    total = 0;
    qty = 0;
  ...
  Future<void> proses_export_lapstockb(int mode) async {
