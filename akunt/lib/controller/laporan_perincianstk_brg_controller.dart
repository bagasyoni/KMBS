...
import '../model/model_lapperincianstk_brg.dart';
import '../model/model_periode.dart';

class LapPerincianstkbrgController with ChangeNotifier {
  final Future<SharedPreferences> _prefs = SharedPreferences.getInstance();
  SharedPreferences prefs;
  model_lapperincianstk_brg m_lapperincianstk_brg = model_lapperincianstk_brg();
  ...
  Future<void> select_data() async {
    ...
    data_list = await m_lapperincianstk_brg.data_lap(filterpermodal);
    awal = 0;
    masuk = 0;
    keluar = 0;
    lain = 0;
  ...
  Future<void> proses_export_lapperincianstkbrg(int mode) async {
    if (data_list.length > 0) {
      ...
      String judul = "Laporan Perincian Stok Barang";
      String header_title = "";
      if (mode == 0) {
