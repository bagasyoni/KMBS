...
class FilterTanggalNoSP extends StatefulWidget {
  @override
  _FilterTanggalNoSPState createState() => _FilterTanggalNoSPState();
}

class _FilterTanggalNoSPState extends State<FilterTanggalNoSP> {
  @override
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller: beliController.filter_tanggalController,
                          onSelectionChanged: beliController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (beliController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (beliController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
