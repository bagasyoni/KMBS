...
Widget PobahanCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<PobahanimportController>(
    ...
    int offset =
        Provider.of<PobahanimportController>(context, listen: false).offset;
    var data_pobahan = pobahanimportController.data_pobahan_list[index];
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          pobahanimportController.index_terpilih = index;
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: (index == pobahanimportController.index_terpilih)
                    ? HijauColor
                    : GreyColor),
            color: Colors.white,
          ),
