...
import 'package:akunt/view/transaksi/operasional/btb_bahan_import/pilih_currency.dart';
import 'package:akunt/view/base_widget/save_success.dart';
import 'package:intl/intl.dart';
import 'package:provider/provider.dart';

class AddBtbBahanImportScreen extends StatefulWidget {
  bool isModeEdit;
  var dataEdit;
  ...
  void initState() {
    if (widget.isModeEdit) {
      Provider.of<BtbBahanImportController>(context, listen: false)
          .initDataEditBtbBahanImport(widget.dataEdit);
    } else {
      Provider.of<BtbBahanImportController>(context, listen: false)
          .initDataAddBtbBahanImport();
    }
    super.initState();
  }
        ...
        appBar: AppBar(
          ...
          title: Row(
            children: [
              ...
              Text(
                (widget.isModeEdit)
                    ? "Edit Bukti Terima Bahan Import"
                    : "Tambah Bukti Terima Bahan Import",
          ...
          actions: [
            OnHoverButton(
              child: InkWell(
                onTap: () {
                  if (widget.isModeEdit) {
                    btbBahanImportController.editBtbBahanImport().then((value) {
                      if (value != null) {
                        if (value) {
                    ...
                    btbBahanImportController.saveBtbBahanImport().then((value) {
                      if (value != null) {
                        if (value) {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller: btbBahanImportController
                                            .noBuktiController,
                ...
                child: Card(
                  ...
                  child: Container(
                    ...
                    child: searchTextField =
                      ...
                      itemSubmitted: (item) {
                        DataPodBahanImport db_item = DataPodBahanImport(
                          noid: item.noid,
                          kdbhn: item.kdbhn,
                          nabhn: item.nabhn,
                          notes: item.notes,
                        ...
                        btbBahanImportController.addKeranjang(db_item);
                      },
                      submitOnSuggestionTap: true,
                      clearOnSubmit: false,
                      key: key,
                      suggestions: btbBahanImportController.podBhnImportList,
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  btbBahanImportController.sumQty.toString(),
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding:
                                    EdgeInsets.only(left: 8, right: 8, top: 6),
                                child: Text(
                                  f.format(btbBahanImportController.sumTotal),
                                  textAlign: TextAlign.right,
                                  style: GoogleFonts.poppins(
                                      fontSize: 13,
                                      fontWeight: FontWeight.w600,
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding:
                                    EdgeInsets.only(left: 8, right: 8, top: 6),
                                child: Text(
                                  f.format(btbBahanImportController.sumTotal1),
                                  textAlign: TextAlign.right,
                                  style: GoogleFonts.poppins(
                                      fontSize: 13,
                                      fontWeight: FontWeight.w600,
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                textAlign: TextAlign.right,
                                controller:
                                    btbBahanImportController.discController,
                                ...
                                onChanged: (numb) {
                                  if (numb.isNotEmpty) {
                                    btbBahanImportController.disc = config()
                                        .convert_rupiah(btbBahanImportController
                                            .discController.text);
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding:
                                    EdgeInsets.only(left: 8, right: 8, top: 6),
                                child: Text(
                                  f.format(btbBahanImportController.sumDisc),
                                  textAlign: TextAlign.right,
                                  style: GoogleFonts.poppins(
                                      fontSize: 13,
                                      fontWeight: FontWeight.w600,
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                textAlign: TextAlign.right,
                                controller:
                                    btbBahanImportController.disc1Controller,
                                keyboardType: TextInputType.number,
                                inputFormatters: <TextInputFormatter>[
                                  // WhitelistingTextInputFormatter(
                                  //     RegExp("[0-9]")),
                                ...
                                onChanged: (numb) {
                                  if (numb.isNotEmpty) {
                                    btbBahanImportController.disc1 = config()
                                        .convert_rupiah(btbBahanImportController
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding:
                                    EdgeInsets.only(left: 8, right: 8, top: 6),
                                child: Text(
                                  f.format(btbBahanImportController.sumDisc1),
                                  textAlign: TextAlign.right,
                                  style: GoogleFonts.poppins(
                                      fontSize: 12,
                                      fontWeight: FontWeight.w600,
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                textAlign: TextAlign.right,
                                controller:
                                    btbBahanImportController.ppnController,
                                readOnly: true,
                                decoration: InputDecoration(
                                  contentPadding:
                                      EdgeInsets.only(top: 12, bottom: 13),
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding:
                                    EdgeInsets.only(left: 8, right: 8, top: 6),
                                child: Text(
                                  f.format(btbBahanImportController.sumPPN),
                                  textAlign: TextAlign.right,
                                  style: GoogleFonts.poppins(
                                      fontSize: 12,
                                      fontWeight: FontWeight.w600,
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                textAlign: TextAlign.right,
                                controller:
                                    btbBahanImportController.ppn1Controller,
                                readOnly: true,
                                decoration: InputDecoration(
                                  contentPadding:
                                      EdgeInsets.only(top: 12, bottom: 13),
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding:
                                    EdgeInsets.only(left: 8, right: 8, top: 6),
                                child: Text(
                                  f.format(btbBahanImportController.sumPPN1),
                                  textAlign: TextAlign.right,
                                  style: GoogleFonts.poppins(
                                      fontSize: 12,
                                      fontWeight: FontWeight.w600,
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                textAlign: TextAlign.right,
                                controller:
                                    btbBahanImportController.pphController,
                                keyboardType: TextInputType.number,
                                inputFormatters: <TextInputFormatter>[
                                  // WhitelistingTextInputFormatter(
                                  //     RegExp("[0-9]")),
                                ...
                                onChanged: (numb) {
                                  if (numb.isNotEmpty) {
                                    btbBahanImportController.pph = config()
                                        .convert_rupiah(btbBahanImportController
                                            .pphController.text);
                                    btbBahanImportController.hitungSubTotal();
                                  }
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding:
                                    EdgeInsets.only(left: 8, right: 8, top: 6),
                                child: Text(
                                  f.format(btbBahanImportController.sumPPH),
                                  textAlign: TextAlign.right,
                                  style: GoogleFonts.poppins(
                                      fontSize: 12,
                                      fontWeight: FontWeight.w600,
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                textAlign: TextAlign.right,
                                controller:
                                    btbBahanImportController.pph1Controller,
                                keyboardType: TextInputType.number,
                                inputFormatters: <TextInputFormatter>[
                                  // WhitelistingTextInputFormatter(
                                  //     RegExp("[0-9]")),
                                ...
                                onChanged: (numb) {
                                  if (numb.isNotEmpty) {
                                    btbBahanImportController.pph1 = config()
                                        .convert_rupiah(btbBahanImportController
                                            .pph1Controller.text);
                                    btbBahanImportController.hitungSubTotal();
                                  }
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding:
                                    EdgeInsets.only(left: 8, right: 8, top: 6),
                                child: Text(
                                  f.format(btbBahanImportController.sumPPH1),
                                  textAlign: TextAlign.right,
                                  style: GoogleFonts.poppins(
                                      fontSize: 12,
                                      fontWeight: FontWeight.w600,
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding:
                                    EdgeInsets.only(left: 8, right: 8, top: 6),
                                child: Text(
                                  f.format(btbBahanImportController.sumNett),
                                  textAlign: TextAlign.right,
                                  style: GoogleFonts.poppins(
                                      fontSize: 12,
                                      fontWeight: FontWeight.w600,
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding:
                                    EdgeInsets.only(left: 8, right: 8, top: 6),
                                child: Text(
                                  f.format(btbBahanImportController.sumNett1),
                                  textAlign: TextAlign.right,
                                  style: GoogleFonts.poppins(
                                      fontSize: 12,
                                      fontWeight: FontWeight.w600,
                    ...
                    children: [
                      TextSpan(
                        text: config().format_rupiah(
                            btbBahanImportController.sumTotal.toString()),
                        style: GoogleFonts.poppins(
                            fontSize: 16,
                            fontWeight: FontWeight.w600,
                            color: Colors.black),
