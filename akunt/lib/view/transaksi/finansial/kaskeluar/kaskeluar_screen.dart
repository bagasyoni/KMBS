...
import 'package:akunt/view/transaksi/finansial/kaskeluar/add_kaskeluar_screen.dart';
import 'package:akunt/view/transaksi/finansial/kaskeluar/widget/kaskeluar_card.dart';
...
class _KasKeluarScreenState extends State<KasKeluarScreen> {
  ...
  @override
  void initState() {
    Provider.of<KaskController>(context, listen: false).initData();
    super.initState();
  }
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                flex: 2,
                child: (kaskeluarController.data_kask_list.length > 0)
                    ? ListView.builder(
                        padding: const EdgeInsets.symmetric(
                            horizontal: 32, vertical: 24),
                        itemCount: kaskeluarController.data_kask_list.length,
                          ...
                          return KaskCard(index, pressEdit: () {
                            ...
                            showAnimatedDialog_withCallBack(
                              ...
                              if (value != null) {
                                if (value) {
                                  kaskeluarController
                                      .deleteKask(kaskeluarController
                                          .data_kask_list[index]['NO_BUKTI'])
                                      .then((value) {
                                    if (value) {
