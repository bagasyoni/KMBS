...
import 'package:akunt/view/kaskeluar/add_kaskeluar_screen.dart';
import 'package:akunt/view/kaskeluar/widget/kaskeluar_card.dart';
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: (kaskeluarController.data_order_penjualan_list.length > 0)
                    ? ListView.builder(
                        padding: const EdgeInsets.symmetric(
                            horizontal: 32, vertical: 24),
                        itemCount:
                            kaskeluarController.data_order_penjualan_list.length,
