...
Widget AddKasKeluarCard(
  ...
  // double jumlahrp = data_hutang.jumlahrp;
  // double um = data_hutang.um;
  // double rate = data_hutang.rate;
  ...
  var kaskeluarController = Provider.of<KaskController>(context, listen: false);
    ...
    child: Container(
      ...
      child: Row(
        children: [
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      kaskeluarController.data_hutang_keranjang[index].acno =
                          acnoController.text;
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      kaskeluarController.data_hutang_keranjang[index].nacno =
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      kaskeluarController.data_hutang_keranjang[index].uraian =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      kaskeluarController.data_hutang_keranjang[index].jumlah =
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onFieldSubmitted: (value) {
                    kaskeluarController.data_hutang_keranjang[index].jumlahrp =
                        config().convert_rupiah(jumlahrpController.text);
                    kaskeluarController.hitungSubTotal();
                  },
                ),
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      kaskeluarController.data_hutang_keranjang[index].um =
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      kaskeluarController.data_hutang_keranjang[index].curr =
                          currController.text;
                      // kaskeluarController.hitungSubTotal();
                      kaskeluarController.notifyListeners();
                    }
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      kaskeluarController.data_hutang_keranjang[index].rate =
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      kaskeluarController.data_hutang_keranjang[index].noinv =
          ...
          InkWell(
            onTap: () {
              kaskeluarController.data_hutang_keranjang.removeAt(index);
              kaskeluarController.hitungSubTotal();
            },
            child: Padding(
