...
import 'package:akunt/view/transaksi/finansial/bankmasuk/pilih_customer.dart';
import 'package:akunt/view/transaksi/finansial/bankmasuk/pilih_account.dart';
import 'package:akunt/view/transaksi/finansial/bankmasuk/pilih_currency.dart';
import 'package:akunt/view/transaksi/finansial/bankmasuk/widget/add_bankmasuk_card.dart';
  ...
  void initState() {
    if (widget.isModeEdit) {
      Provider.of<BankmController>(context, listen: false)
          .initData_editBankm(widget.data_edit);
    } else {
      Provider.of<BankmController>(context, listen: false).initData_addBankm();
    }
    super.initState();
  }
          ...
          actions: [
            OnHoverButton(
              child: InkWell(
                onTap: () {
                  if (widget.isModeEdit) {
                    bankmasukController.editBankm().then((value) {
                      if (value != null) {
                        if (value) {
                    ...
                    bankmasukController.saveBankm().then((value) {
                      if (value != null) {
                        if (value) {
                          showAnimatedDialog_withCallBack(
                            ...
                            if (value != null) {
                              if (value) {
                                bankmasukController.initData_addBankm();
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            bankmasukController.currController,
                                        readOnly: widget.isModeEdit,
                                        decoration: InputDecoration(
                                          hintText: "Cari Disini",
                                          hintStyle: GoogleFonts.poppins(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            bankmasukController.kodeController,
                                        readOnly: widget.isModeEdit,
                                        decoration: InputDecoration(
                                          hintText: "Cari Disini",
                                          hintStyle: GoogleFonts.poppins(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            bankmasukController.namaController,
                                        readOnly: true,
                                        decoration: InputDecoration(
                                          contentPadding: EdgeInsets.only(
                                              top: 15, bottom: 15),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            bankmasukController.ketController,
                                        // readOnly: widget.isModeEdit,
                                        decoration: InputDecoration(
                                          contentPadding: EdgeInsets.only(
                                              top: 15, bottom: 15),
                ...
                child: Card(
                  ...
                  child: Container(
                    ...
                    child: searchTextField = AutoCompleteTextField<DataPiutang>(
                      ...
                      clearOnSubmit: false,
                      key: key,
                      suggestions: bankmasukController.piutangList,
                ...
                child: SingleChildScrollView(
                    ...
                    child: Container(
                      ...
                      child: ListView.builder(
                        itemCount:
                            bankmasukController.data_piutang_keranjang.length,
                        itemBuilder: (BuildContext context, int index) {
                          return AddBankMasukCard(
                              context,
                              index,
                              bankmasukController
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  f.format(bankmasukController.sumJumlah),
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding:
                                    EdgeInsets.only(left: 8, right: 8, top: 6),
                                child: Text(
                                  f.format(bankmasukController.sumJumlahRp),
                                  textAlign: TextAlign.right,
                                  style: GoogleFonts.poppins(
                                      fontSize: 13,
                                      fontWeight: FontWeight.w600,
