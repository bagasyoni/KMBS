    ...
    child: Container(
      ...
      child: Row(
        children: [
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      giromasukController.data_piutang_keranjang[index].acno =
                          acnoController.text;
                      giromasukController.hitungSubTotal();
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      giromasukController.data_piutang_keranjang[index].nacno =
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      giromasukController.data_piutang_keranjang[index].uraian =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      giromasukController.data_piutang_keranjang[index].jumlah =
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onFieldSubmitted: (value) {
                    giromasukController.data_piutang_keranjang[index].jumlahrp =
                        config().convert_rupiah(jumlahrpController.text);
                    giromasukController.hitungSubTotal();
                  },
                ),
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      giromasukController.data_piutang_keranjang[index].um =
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      giromasukController.data_piutang_keranjang[index].curr =
                          currController.text;
                      // giromasukController.hitungSubTotal();
                      giromasukController.notifyListeners();
                    }
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      giromasukController.data_piutang_keranjang[index].rate =
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      giromasukController.data_piutang_keranjang[index].noinv =
          ...
          InkWell(
            onTap: () {
              giromasukController.data_piutang_keranjang.removeAt(index);
              giromasukController.hitungSubTotal();
            },
            child: Padding(
