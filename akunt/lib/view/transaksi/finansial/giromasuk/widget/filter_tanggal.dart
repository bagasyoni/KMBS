          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              giromasukController.filter_tanggalController,
                          onSelectionChanged:
                              giromasukController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (giromasukController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (giromasukController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
