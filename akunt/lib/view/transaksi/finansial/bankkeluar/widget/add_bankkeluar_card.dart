            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onFieldSubmitted: (value) {
                    bankkeluarController.data_account_keranjang[index].jumlah1 =
                        config().convert_rupiah(jumlah1Controller.text);
                    bankkeluarController.hitungSubTotal();
                  },
                ),
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      bankkeluarController.data_account_keranjang[index].um =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      bankkeluarController.data_account_keranjang[index].currd =
