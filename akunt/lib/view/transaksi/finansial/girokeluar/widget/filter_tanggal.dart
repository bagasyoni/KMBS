          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              girokeluarController.filter_tanggalController,
                          onSelectionChanged:
                              girokeluarController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (girokeluarController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (girokeluarController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
