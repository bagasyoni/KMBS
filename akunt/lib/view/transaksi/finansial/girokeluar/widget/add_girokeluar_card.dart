    ...
    child: Container(
      ...
      child: Row(
        children: [
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      girokeluarController.data_hutang_keranjang[index].acno =
                          acnoController.text;
                      girokeluarController.hitungSubTotal();
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      girokeluarController.data_hutang_keranjang[index].nacno =
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      girokeluarController.data_hutang_keranjang[index].uraian =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      girokeluarController.data_hutang_keranjang[index].jumlah =
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onFieldSubmitted: (value) {
                    girokeluarController.data_hutang_keranjang[index].jumlahrp =
                        config().convert_rupiah(jumlahrpController.text);
                    girokeluarController.hitungSubTotal();
                  },
                ),
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      girokeluarController.data_hutang_keranjang[index].um =
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      girokeluarController.data_hutang_keranjang[index].curr =
                          currController.text;
                      // girokeluarController.hitungSubTotal();
                      girokeluarController.notifyListeners();
                    }
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      girokeluarController.data_hutang_keranjang[index].rate =
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      girokeluarController.data_hutang_keranjang[index].noinv =
          ...
          InkWell(
            onTap: () {
              girokeluarController.data_hutang_keranjang.removeAt(index);
              girokeluarController.hitungSubTotal();
            },
            child: Padding(
