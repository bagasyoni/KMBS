...
import 'package:akunt/controller/laporan_pobahanlokal_controller.dart';
import 'package:akunt/view/base_widget/toast.dart';
import 'package:provider/provider.dart';
import 'package:flutter/material.dart';

class PilihBahanB extends StatefulWidget {
  String bahan_terpilih;
  var controller;

  PilihBahanB(this.bahan_terpilih, this.controller);

  @override
  _PilihBahanState createState() => _PilihBahanState();
}

class _PilihBahanState extends State<PilihBahanB> {
  ///FILTER PERIODE
  LapPobahanlokalController lapPobahanlokal;
              ...
              Expanded(
                ...
                onTap: () async {
                  if (index_terpilih != null) {
                    widget.controller.bahan2Controller.text = bahanController
                        .data_bahanList[index_terpilih]['KD_BHN'];

                    ///FILTER PERIODE///
                    LapPobahanlokalController.bahan_b = bahanController
                        .data_bahanList[index_terpilih]['KD_BHN'];
  ...
  Widget BahanCard(int index) {
    ...
    if (widget.bahan_terpilih != null) {
      if (data_bahan['KD_BHN'] == widget.bahan_terpilih) {
        isActive = true;
    ...
    return InkWell(
      onTap: () {
        index_terpilih = index;
        widget.bahan_terpilih = data_bahan['KD_BHN'];
        setState(() {});
      },
      child: Container(
