...
class PilihSupplierB extends StatefulWidget {
  String supplier_terpilih;
  var controller;

  PilihSupplierB(this.supplier_terpilih, this.controller);

  @override
  _PilihSupplierState createState() => _PilihSupplierState();
}

class _PilihSupplierState extends State<PilihSupplierB> {
  ///FILTER SUPPLIER
              ...
              Expanded(
                ...
                onTap: () async {
                  if (index_terpilih != null) {
                    widget.controller.sup2Controller.text = supplierController
                        .data_supplierList[index_terpilih]['KODES'];

                    ///FILTER PERIODE///
                    LapPobahanlokalController.supplier_b = supplierController
                        .data_supplierList[index_terpilih]['KODES'];
