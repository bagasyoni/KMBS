...
class _PilihPobahanState extends State<PilihPobahan> {
  ...
  @override
  void initState() {
    Provider.of<PobahanController>(context, listen: false).selectData("");
    super.initState();
  }
  ...
  Widget PobahanCard(int index) {
    ...
    var data_po = Provider.of<PobahanController>(context, listen: false)
    ...
    return InkWell(
      onTap: () {
        ...
        index_terpilih = index;
        dataterpilih = Provider.of<PobahanController>(context, listen: false)
