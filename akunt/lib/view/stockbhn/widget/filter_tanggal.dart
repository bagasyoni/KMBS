          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              stockbhnController.filter_tanggalController,
                          onSelectionChanged:
                              stockbhnController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (stockbhnController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (stockbhnController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
