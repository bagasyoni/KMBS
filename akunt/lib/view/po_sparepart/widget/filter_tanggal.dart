          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              PosparepartController.filter_tanggalController,
                          onSelectionChanged:
                              PosparepartController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (PosparepartController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (PosparepartController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
