          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller: lapJualbahan.filter_tanggalController,
                          onSelectionChanged: lapJualbahan.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (lapJualbahan.isEnable_button) {
                      lapJualbahan.select_data();
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (lapJualbahan.isEnable_button)
                          ? HijauColor
                          : GreyColor,
