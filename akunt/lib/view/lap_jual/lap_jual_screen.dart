...
import '../../controller/laporan_jual_controller.dart';
import '../../controller/jual_controller.dart';
import 'widget/filter_tanggal.dart';

class LapJualScreen extends StatefulWidget {
  @override
  _LapJualScreenState createState() => _LapJualScreenState();
}

class _LapJualScreenState extends State<LapJualScreen> {
  String baseUrl = base_url;
  @override
  void initState() {
    Provider.of<LapJualController>(context, listen: false).initData();
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<LapJualController>(builder: (context, lapJualbahan, child) {
      return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            OnHoverButton(
              child: InkWell(
                hoverColor: Colors.white,
                onTap: () {
                  lapJualbahan.proses_export_lapbelibahan(1);
                },
                child: Container(
                  height: 30,
                  child: Row(
        ...
        body: Container(
          ...
          child: Column(
            children: [
                      ...
                      child: InkWell(
                        onTap: () {
                          showAnimatedDialog_withCallBack(
                            ...
                            if (value != null) {
                              if (value) {
                                // lapJualbahan.initData_add();
                                lapJualbahan.notifyListeners();
                              } else {
                                lapJualbahan.notifyListeners();
              ...
              Expanded(
                child: (lapJualbahan.data_list.length > 0)
                    ? ListView(children: [
                        Padding(
                          ...
                          child: PaginatedDataTable(
                            source: MyData(
                                lapJualbahan.data_list, context, lapJualbahan),
              ...
              children: [
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: lapJualbahan.data_list.length.toString(),
                        style: GoogleFonts.poppins(
                            fontWeight: FontWeight.w500,
                            fontSize: 16,
                            color: Colors.black),
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: lapJualbahan.qty.toString(),
                        style: GoogleFonts.poppins(
                            fontWeight: FontWeight.w500,
                            fontSize: 16,
                            color: Colors.black),
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: config()
                            .format_rupiah(lapJualbahan.total.toString()),
                        style: GoogleFonts.poppins(
                            fontWeight: FontWeight.w500,
                            fontSize: 16,
                            color: Colors.black),
  ...
  Widget pageField() {
    JualController pageTerima =
        Provider.of<JualController>(context, listen: false);
    return Container(
      width: 70,
      height: 35,
      child: TextField(
...
class MyData extends DataTableSource {
  ...
  LapJualController lapJualbahan;
  MyData(this.dtx, this.context, this.lapJualbahan);
