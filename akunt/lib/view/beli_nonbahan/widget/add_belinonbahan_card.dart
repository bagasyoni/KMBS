...
Widget AddBelinonbahanCard(BuildContext context, int index, DataPod data_pod) {
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      belibahanController.data_pod_keranjang[index].nabhn =
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      belibahanController.data_pod_keranjang[index].dr =
                          drController.text;
                      belibahanController.hitungSubTotal();
                      belibahanController.notifyListeners();
                    }
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      belibahanController.data_pod_keranjang[index].satuanpp =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      belibahanController.data_pod_keranjang[index].qtypp =
                          qtypp;
                      if (qtypp <= 0) {
                        belibahanController.data_pod_keranjang.removeAt(index);
                      }
                      belibahanController.hitungSubTotal();
                    }
                  },
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      belibahanController.data_pod_keranjang[index].satuan =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      //   ),
                      // );
                      belibahanController.data_pod_keranjang[index].qty =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      belibahanController.data_pod_keranjang[index].harga =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      //   ),
                      // );
                      belibahanController.data_pod_keranjang[index].bulat =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      //   ),
                      // );
                      belibahanController.data_pod_keranjang[index].disk =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      //   ),
                      // );
                      belibahanController.data_pod_keranjang[index].val =
