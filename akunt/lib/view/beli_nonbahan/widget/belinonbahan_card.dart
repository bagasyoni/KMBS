...
Widget BelinonbahanCard(int index, {Function pressEdit, Function pressDelete}) {
  return Consumer<BelinonbahanController>(
    ...
    String namas = data_belinonbahan['NAMAS'];
    String nett = config().format_rupiah(data_belinonbahan['NETT'].toString());
    bool isDelivered = data_belinonbahan['POSTED'] == 1 ? true : false;
    return Padding(
