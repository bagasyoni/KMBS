          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              BelimesinController.filter_tanggalController,
                          onSelectionChanged:
                              BelimesinController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (BelimesinController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (BelimesinController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
