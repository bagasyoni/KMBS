...
import 'package:akunt/view/jual/add_jual_screen.dart';
import 'package:akunt/view/jual/widget/jual_card.dart';
import 'package:provider/provider.dart';

import 'widget/filter_tanggal.dart';

class DataJualScreen extends StatefulWidget {
  @override
  _JualScreenState createState() => _JualScreenState();
}

class _JualScreenState extends State<DataJualScreen> {
  @override
  void initState() {
    Provider.of<JualController>(context, listen: false).initData();
    super.initState();
  }
          ...
          actions: [
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => AddJualScreen(false)))
                        .then((value) {
                      if (value != null) {
                        if (value) {
                          jualController.select_data();
                        }
                      }
                    });
                  },
              ...
              child: InkWell(
                ...
                onTap: () {
                  showAnimatedDialog_withCallBack(context, ModeExport(1),
                    ...
                    if (value != null) {
                      if (value == 1) {
                        jualController.proses_export_detail();
                      } else if (value == 2) {
                        jualController.proses_export();
                      }
                    }
                  });
                },
            ...
            OnHoverButton(
              child: InkWell(
                hoverColor: Colors.white,
                onTap: () {
                  if (jualController.index_terpilih != null) {
                    jualController.proses_print();
                  } else {
                    Toast(
                        "Peringatan",
        ...
        body: Container(
          ...
          child: Column(
            children: [
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Container(
                                height: 30,
                                child: TextField(
                                  controller: jualController.searchController,
                        ...
                        onTap: () {
                          showAnimatedDialog_withCallBack(
                            ...
                            if (value != null) {
                              if (value) {
                                jualController.select_data();
                                jualController.notifyListeners();
                              } else {
                                jualController.notifyListeners();
              ...
              Expanded(
                child: (jualController.data_jual_list.length > 0)
                    ? ListView.builder(
                        padding: const EdgeInsets.symmetric(
                            horizontal: 32, vertical: 24),
                        itemCount: jualController.data_jual_list.length,
                        itemBuilder: (BuildContext context, int index) {
                          return JualCard(index, pressEdit: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (_) => AddJualScreen(
                                          true,
                                          data_edit: jualController
