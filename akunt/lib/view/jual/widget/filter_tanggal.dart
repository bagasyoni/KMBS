...
class _FilterTanggalState extends State<FilterTanggal> {
  ...
  Widget build(BuildContext context) {
    return Consumer<JualController>(
        builder: (context, JualController, child) {
      return Dialog(
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              JualController.filter_tanggalController,
                          onSelectionChanged:
                              JualController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (JualController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (JualController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
