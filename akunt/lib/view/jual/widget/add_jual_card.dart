...
Widget AddJualCard(BuildContext context, int index, DataBrg data_brg) {
  ...
  var jualController = Provider.of<JualController>(context, listen: false);
    ...
    child: Container(
      ...
      child: Row(
        children: [
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      jualController.data_brg_keranjang[index].harga =
                          config().convert_rupiah(hargaController.text);
                      jualController.notifyListeners();
                      jualController.hitungSubTotal();
                    }
                  },
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      jualController.data_brg_keranjang[index].qty =
          ...
          InkWell(
            onTap: () {
              jualController.data_brg_keranjang.removeAt(index);
              jualController.hitungSubTotal();
            },
            child: Padding(
