          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              PomesinController.filter_tanggalController,
                          onSelectionChanged:
                              PomesinController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (PomesinController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (PomesinController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
