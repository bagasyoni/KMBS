...
Widget AddPomesinCard(BuildContext context, int index, DataBrg data_brg) {
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      pomesinController.data_brg_keranjang[index].na_brg =
                          nabrgController.text;
                      pomesinController.hitungSubTotal();
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      pomesinController.data_brg_keranjang[index].satuan =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      pomesinController.data_brg_keranjang[index].qty = qty;
                      if (qty <= 0) {
                        pomesinController.data_brg_keranjang.removeAt(index);
                      }
                      pomesinController.hitungSubTotal();
                    }
                  },
                  onFieldSubmitted: (value) {
                    pomesinController.data_brg_keranjang[index].qty =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      pomesinController.data_brg_keranjang[index].harga =
