...
import '../../controller/laporan_kas_controller.dart';
import 'widget/filter_tanggal.dart';

class LapKasScreen extends StatefulWidget {
  @override
  _LapKasScreenState createState() => _LapKasScreenState();
}

class _LapKasScreenState extends State<LapKasScreen> {
  String baseUrl = base_url;
  @override
  void initState() {
    Provider.of<LapKasController>(context, listen: false).initData();
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<LapKasController>(builder: (context, lapKas, child) {
      return Scaffold(
        appBar: AppBar(
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: (lapKas.data_list.length > 0)
                    ? ListView(children: [
                        Padding(
                          padding: EdgeInsets.only(
                              left: 24, right: 24, top: 16, bottom: 4),
                          child: PaginatedDataTable(
                            source: MyData(lapKas.data_list, context, lapKas),
...
class MyData extends DataTableSource {
  ...
  LapKasController lapKas;
  MyData(this.dtx, this.context, this.lapKas);
