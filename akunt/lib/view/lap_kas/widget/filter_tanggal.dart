...
class _FilterTanggalState extends State<FilterTanggal> {
  ...
  Widget build(BuildContext context) {
    return Consumer<LapKasController>(builder: (context, lapKasbahan, child) {
      return Dialog(
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller: lapKasbahan.filter_tanggalController,
                          onSelectionChanged: lapKasbahan.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (lapKasbahan.isEnable_button) {
                      lapKasbahan.select_data();
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (lapKasbahan.isEnable_button)
                          ? HijauColor
                          : GreyColor,
