          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              mutasibhnController.filter_tanggalController,
                          onSelectionChanged:
                              mutasibhnController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (mutasibhnController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (mutasibhnController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
