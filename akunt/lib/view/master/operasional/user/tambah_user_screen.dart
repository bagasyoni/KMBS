...
import 'package:akunt/view/master/operasional/user/widget/keterangan_lain.dart';
...
class TambahUserScreen extends StatefulWidget {
  ...
  TambahUserScreen({this.isModeEdit, this.data_user});
  ...
  void initState() {
    ...
    if (widget.isModeEdit) {
      Provider.of<UserController>(context, listen: false)
          .init_edit_user(widget.data_user);
    } else {
      Provider.of<UserController>(context, listen: false).resetField();
    }
    super.initState();
  }
        ...
        appBar: AppBar(
          ...
          title: Row(
            children: [
              ...
              Text(
                (widget.isModeEdit) ? "Edit User" : "Tambah User",
            ...
            children: [
              ...
              Expanded(
                child: TabBarView(
                  ...
                  controller: _tabController,
                  children: <Widget>[
                    KeteranganUmum(userController),
                    KeteranganLain(context, userController),
                  ],
                ),
              ),
            ],
                    ...
                    OnHoverButton(
                      child: InkWell(
                        ...
                        onTap: () {
                          if (widget.isModeEdit) {
                            userController
                                .edit_user(widget.data_user['Username'])
                                .then((value) {
                              if (value != null) {
                                if (value) {
                                  Navigator.pop(context);
                            ...
                            userController.daftar_user().then((value) {
                              if (value != null) {
                                if (value) {
                                  Navigator.pop(context);
                                }
