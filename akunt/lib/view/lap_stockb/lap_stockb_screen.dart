...
import '../../controller/mutasibrg_controller.dart';
import 'widget/filter_tanggal.dart';

class LapStockbScreen extends StatefulWidget {
  @override
  _LapStockbScreenState createState() => _LapStockbScreenState();
}

class _LapStockbScreenState extends State<LapStockbScreen> {
  String baseUrl = base_url;
  @override
  void initState() {
    Provider.of<LapStockbController>(context, listen: false).initData();
    super.initState();
  }
          ...
          actions: [
            ...
            OnHoverButton(
              child: InkWell(
                hoverColor: Colors.white,
                onTap: () {
                  lapStockb.proses_export_lapstockb(1);
                },
                child: Container(
                  height: 30,
                  child: Row(
        ...
        body: Container(
          ...
          child: Column(
            children: [
                      ...
                      child: InkWell(
                        onTap: () {
                          showAnimatedDialog_withCallBack(
                            ...
                            if (value != null) {
                              if (value) {
                                // lapStockb.initData_add();
                                lapStockb.notifyListeners();
                              } else {
                                lapStockb.notifyListeners();
              ...
              Expanded(
                child: (lapStockb.data_list.length > 0)
                    ? ListView(children: [
                        Padding(
                          ...
                          child: PaginatedDataTable(
                            source:
                                MyData(lapStockb.data_list, context, lapStockb),
              ...
              children: [
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: lapStockb.data_list.length.toString(),
                        style: GoogleFonts.poppins(
                            fontWeight: FontWeight.w500,
                            fontSize: 16,
                            color: Colors.black),
...
class MyData extends DataTableSource {
  ...
  LapStockbController lapStockb;
  MyData(this.dtx, this.context, this.lapStockb);
