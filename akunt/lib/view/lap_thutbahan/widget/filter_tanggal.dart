          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller: lapThutbahan.filter_tanggalController,
                          onSelectionChanged: lapThutbahan.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (lapThutbahan.isEnable_button) {
                      lapThutbahan.select_data();
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (lapThutbahan.isEnable_button)
                          ? HijauColor
                          : GreyColor,
