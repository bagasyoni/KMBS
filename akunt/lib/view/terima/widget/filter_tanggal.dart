          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              terimabhnController.filter_tanggalController,
                          onSelectionChanged:
                              terimabhnController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (terimabhnController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (terimabhnController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
