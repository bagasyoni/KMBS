...
class _FilterTanggalState extends State<FilterTanggal> {
  ...
  Widget build(BuildContext context) {
    return Consumer<HutbahanController>(
        builder: (context, HutbahanController, child) {
      return Dialog(
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              HutbahanController.filter_tanggalController,
                          onSelectionChanged:
                              HutbahanController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (HutbahanController.isEnable_button) {
                      HutbahanController.select_data();
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (HutbahanController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
