...
class DataSoScreen extends StatefulWidget {
  @override
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: (soController.data_so_list.length > 0)
                    ? ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return SoCard(index, pressEdit: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (_) => AddSoScreen(
                                          true,
                                          data_edit: soController
                                              .data_so_list[index],
                                        ))).then((value) {
                              if (value != null) {
                                if (value) {
                            ...
                            showAnimatedDialog_withCallBack(
                              ...
                              if (value != null) {
                                if (value) {
                                  soController
                                      .deleteSo(soController
                                          .data_so_list[index]['NO_BUKTI'])
                                      .then((value) {
                                    if (value) {
