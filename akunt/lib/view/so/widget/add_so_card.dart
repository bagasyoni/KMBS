...
Widget AddSoCard(BuildContext context, int index, DataBrg data_brg) {
  ...
  var soController = Provider.of<SoController>(context, listen: false);
    ...
    child: Container(
      ...
      child: Row(
        children: [
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      soController.data_brg_keranjang[index].na_brg =
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      soController.data_brg_keranjang[index].satuan =
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      soController.data_brg_keranjang[index].ket =
                          ketController.text;
                      soController.hitungSubTotal();
                      soController.notifyListeners();
                    }
          ...
          InkWell(
            onTap: () {
              soController.data_brg_keranjang.removeAt(index);
              soController.hitungSubTotal();
            },
            child: Padding(
