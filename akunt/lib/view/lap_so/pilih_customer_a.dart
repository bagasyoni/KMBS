...
class PilihCustomerA extends StatefulWidget {
  String customer_terpilih;
  var controller;

  PilihCustomerA(this.customer_terpilih, this.controller);

  @override
  _PilihCustomerState createState() => _PilihCustomerState();
}

class _PilihCustomerState extends State<PilihCustomerA> {
  ///FILTER PERIODE
              ...
              Expanded(
                ...
                onTap: () async {
                  if (index_terpilih != null) {
                    widget.controller.cus1Controller.text = customerController
                        .data_customerList[index_terpilih]['KODEC'];

                    ///FILTER PERIODE///
                    LapSoController.customer_a = customerController
                        .data_customerList[index_terpilih]['KODEC'];
