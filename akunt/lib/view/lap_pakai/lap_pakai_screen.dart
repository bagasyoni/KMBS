...
import '../../controller/laporan_pakai_controller.dart';
import '../../controller/pakaibhn_controller.dart';
import 'widget/filter_tanggal.dart';

class LapPakaiScreen extends StatefulWidget {
  @override
  _LapPakaiScreenState createState() => _LapPakaiScreenState();
}

class _LapPakaiScreenState extends State<LapPakaiScreen> {
  String baseUrl = base_url;
  @override
  void initState() {
    Provider.of<LapPakaiController>(context, listen: false).initData();
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<LapPakaiController>(builder: (context, lapPakai, child) {
      return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            OnHoverButton(
              child: InkWell(
                hoverColor: Colors.white,
                onTap: () {
                  lapPakai.proses_export_lappakai(1);
                },
                child: Container(
                  height: 30,
                  child: Row(
        ...
        body: Container(
          ...
          child: Column(
            children: [
                      ...
                      child: InkWell(
                        onTap: () {
                          showAnimatedDialog_withCallBack(
                            ...
                            if (value != null) {
                              if (value) {
                                // lapPakai.initData_add();
                                lapPakai.notifyListeners();
                              } else {
                                lapPakai.notifyListeners();
              ...
              Expanded(
                child: (lapPakai.data_list.length > 0)
                    ? ListView(children: [
                        Padding(
                          ...
                          child: PaginatedDataTable(
                            source:
                                MyData(lapPakai.data_list, context, lapPakai),
              ...
              children: [
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: lapPakai.data_list.length.toString(),
                        style: GoogleFonts.poppins(
                            fontWeight: FontWeight.w500,
                            fontSize: 16,
                            color: Colors.black),
...
class MyData extends DataTableSource {
  ...
  LapPakaiController lapPakai;
  MyData(this.dtx, this.context, this.lapPakai);
