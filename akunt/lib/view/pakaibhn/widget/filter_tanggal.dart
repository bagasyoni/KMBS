          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              pakaibhnController.filter_tanggalController,
                          onSelectionChanged:
                              pakaibhnController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (pakaibhnController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (pakaibhnController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
