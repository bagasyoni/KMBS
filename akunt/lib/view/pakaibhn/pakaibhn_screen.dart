...
import 'package:akunt/view/pakaibhn/add_pakaibhn_screen.dart';
import 'package:akunt/view/pakaibhn/widget/pakaibhn_card.dart';
import 'package:provider/provider.dart';

import 'widget/filter_tanggal.dart';

class PakaibhnScreen extends StatefulWidget {
  @override
  _PakaibhnScreenState createState() => _PakaibhnScreenState();
}

class _PakaibhnScreenState extends State<PakaibhnScreen> {
  @override
  void initState() {
    Provider.of<PakaibhnController>(context, listen: false).initData();
    super.initState();
  }
          ...
          actions: [
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => AddPakaibhnScreen(false)))
                        .then((value) {
                      if (value != null) {
                        if (value) {
                          pakaibhnController.select_data();
                        }
                      }
                    });
                  },
              ...
              child: InkWell(
                ...
                onTap: () {
                  showAnimatedDialog_withCallBack(context, ModeExport(1),
                    ...
                    if (value != null) {
                      if (value == 1) {
                        pakaibhnController.proses_export_detail();
                      } else if (value == 2) {
                        pakaibhnController.proses_export();
                      }
                    }
                  });
                },
            ...
            OnHoverButton(
              child: InkWell(
                hoverColor: Colors.white,
                onTap: () {
                  if (pakaibhnController.index_terpilih != null) {
                    pakaibhnController.proses_print();
                  } else {
                    Toast(
                        "Peringatan",
        ...
        body: Container(
          ...
          child: Column(
            children: [
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: TextField(
                                  controller:
                                      pakaibhnController.searchController,
              ...
              Expanded(
                child: (pakaibhnController.data_pakaibhn_list.length > 0)
                    ? ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return PakaibhnCard(index, pressEdit: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (_) => AddPakaibhnScreen(
                                          true,
                                          data_edit: pakaibhnController
