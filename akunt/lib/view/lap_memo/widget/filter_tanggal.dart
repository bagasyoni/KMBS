...
class _FilterTanggalState extends State<FilterTanggal> {
  ...
  Widget build(BuildContext context) {
    return Consumer<LapMemoController>(builder: (context, lapMemo, child) {
      return Dialog(
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller: lapMemo.filter_tanggalController,
                          onSelectionChanged: lapMemo.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (lapMemo.isEnable_button) ? HijauColor : GreyColor,
