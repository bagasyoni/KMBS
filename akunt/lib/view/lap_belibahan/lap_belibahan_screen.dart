...
import '../../controller/laporan_belibahan_controller.dart';
import '../../controller/belibahan_controller.dart';
import 'package:akunt/view/lap_belibahan/widget/filter_tanggal.dart';
import 'package:akunt/view/lap_belibahan/pilih_bahan_a.dart';
import 'package:akunt/view/lap_belibahan/pilih_bahan_b.dart';
import 'package:akunt/view/lap_belibahan/pilih_supplier_a.dart';
import 'package:akunt/view/lap_belibahan/pilih_supplier_b.dart';

class LapBelibahanScreen extends StatefulWidget {
  @override
  _LapBelibahanScreenState createState() => _LapBelibahanScreenState();
}

class _LapBelibahanScreenState extends State<LapBelibahanScreen> {
  String baseUrl = base_url;
  @override
  void initState() {
    Provider.of<LapBelibahanController>(context, listen: false).initData();
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<LapBelibahanController>(
        builder: (context, lapBelibahan, child) {
      return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            OnHoverButton(
              child: InkWell(
                hoverColor: Colors.white,
                onTap: () {
                  lapBelibahan.proses_export_lapbelibahan(1);
                },
                child: Container(
                  height: 30,
                  child: Row(
        ...
        body: Container(
          ...
          child: Column(
            children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                readOnly: true,
                                // focusNode: fokuse,
                                controller: lapBelibahan.sup1Controller,
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                readOnly: true,
                                // focusNode: fokuse,
                                controller: lapBelibahan.sup2Controller,
                                decoration: InputDecoration(
                                  contentPadding:
                                      EdgeInsets.only(top: 18, bottom: 15),
                                  hintText: "Cari Supplier",
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                readOnly: true,
                                // focusNode: fokuse,
                                controller: lapBelibahan.bahan1Controller,
                                decoration: InputDecoration(
                                  contentPadding:
                                      EdgeInsets.only(top: 18, bottom: 15),
                                  hintText: "Cari Bahan",
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                readOnly: true,
                                // focusNode: fokuse,
                                controller: lapBelibahan.bahan2Controller,
                                decoration: InputDecoration(
                                  contentPadding:
                                      EdgeInsets.only(top: 18, bottom: 15),
                                  hintText: "Cari Bahan",
              ...
              Expanded(
                child: (lapBelibahan.data_list.length > 0)
                    ? ListView(children: [
                        Padding(
                          ...
                          child: PaginatedDataTable(
                            source: MyData(
                                lapBelibahan.data_list, context, lapBelibahan),
              ...
              children: [
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: lapBelibahan.data_list.length.toString(),
                        style: GoogleFonts.poppins(
                            fontWeight: FontWeight.w500,
                            fontSize: 16,
                            color: Colors.black),
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: lapBelibahan.qty.toString(),
                        style: GoogleFonts.poppins(
                            fontWeight: FontWeight.w500,
                            fontSize: 16,
                            color: Colors.black),
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text: config()
                            .format_rupiah(lapBelibahan.total.toString()),
                        style: GoogleFonts.poppins(
                            fontWeight: FontWeight.w500,
                            fontSize: 16,
                            color: Colors.black),
  ...
  Widget pageField() {
    BelibahanController pageTerima =
...
class MyData extends DataTableSource {
  ...
  MyData(this.dtx, this.context, this.lapBelibahan);
