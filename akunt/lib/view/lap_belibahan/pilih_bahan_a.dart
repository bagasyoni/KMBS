...
class PilihBahanA extends StatefulWidget {
  String bahan_terpilih;
  var controller;

  PilihBahanA(this.bahan_terpilih, this.controller);

  @override
  _PilihBahanState createState() => _PilihBahanState();
}

class _PilihBahanState extends State<PilihBahanA> {
  ///FILTER PERIODE
              ...
              Expanded(
                ...
                onTap: () async {
                  if (index_terpilih != null) {
                    widget.controller.bahan1Controller.text = bahanController
                        .data_bahanList[index_terpilih]['KD_BHN'];

                    ///FILTER PERIODE///
                    LapBelibahanController.bahan_a = bahanController
                        .data_bahanList[index_terpilih]['KD_BHN'];
