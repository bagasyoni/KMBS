...
class _FilterTanggalState extends State<FilterTanggal> {
  ...
  Widget build(BuildContext context) {
    return Consumer<LapPerincianstkbhnController>(
        builder: (context, lapStocka, child) {
      return Dialog(
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller: lapStocka.filter_tanggalController,
                          onSelectionChanged: lapStocka.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (lapStocka.isEnable_button) {
                      lapStocka.select_data();
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color:
                          (lapStocka.isEnable_button) ? HijauColor : GreyColor,
