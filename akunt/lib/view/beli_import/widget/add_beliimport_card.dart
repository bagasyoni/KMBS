...
Widget AddBeliimportCard(BuildContext context, int index, DataPod data_pod) {
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      beliimportController.data_pod_keranjang[index].nabhn =
                          nabhnController.text;
                      beliimportController.hitungSubTotal();
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      beliimportController.data_pod_keranjang[index].dr =
                          drController.text;
                      beliimportController.hitungSubTotal();
                      beliimportController.notifyListeners();
                    }
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      beliimportController.data_pod_keranjang[index].satuanpp =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      beliimportController.data_pod_keranjang[index].qtypp =
                          qtypp;
                      if (qtypp <= 0) {
                        beliimportController.data_pod_keranjang.removeAt(index);
                      }
                      beliimportController.hitungSubTotal();
                    }
                  },
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      beliimportController.data_pod_keranjang[index].satuan =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      //   ),
                      // );
                      beliimportController.data_pod_keranjang[index].qty =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      beliimportController.data_pod_keranjang[index].harga =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      //   ),
                      // );
                      beliimportController.data_pod_keranjang[index].bulat =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      //   ),
                      // );
                      beliimportController.data_pod_keranjang[index].disk =
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      ...
                      //   ),
                      // );
                      beliimportController.data_pod_keranjang[index].val =
