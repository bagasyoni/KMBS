...
Widget AddSuratCard(BuildContext context, int index, DataBrg data_brg) {
  ...
  var suratController = Provider.of<SuratController>(context, listen: false);
    ...
    child: Container(
      ...
      child: Row(
        children: [
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (numb) {
                    if (numb.isNotEmpty) {
                      suratController.data_brg_keranjang[index].qty =
                          double.parse(qtyController.text);
                      suratController.notifyListeners();
                      suratController.hitungSubTotal();
                    }
                  },
          ...
          InkWell(
            onTap: () {
              suratController.data_brg_keranjang.removeAt(index);
              suratController.hitungSubTotal();
            },
            child: Padding(
