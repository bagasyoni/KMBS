...
import 'package:akunt/view/surat/add_surat_screen.dart';
import 'package:akunt/view/surat/widget/surat_card.dart';
...
class _SuratScreenState extends State<DataSuratScreen> {
  @override
  void initState() {
    Provider.of<SuratController>(context, listen: false).initData();
    super.initState();
  }
          ...
          actions: [
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => AddSuratScreen(false)))
                        .then((value) {
                      if (value != null) {
                        if (value) {
                          suratController.select_data();
                        }
                      }
                    });
                  },
              ...
              child: InkWell(
                ...
                onTap: () {
                  showAnimatedDialog_withCallBack(context, ModeExport(1),
                    ...
                    if (value != null) {
                      if (value == 1) {
                        suratController.proses_export_detail();
                      } else if (value == 2) {
                        suratController.proses_export();
                      }
                    }
                  });
                },
            ...
            OnHoverButton(
              child: InkWell(
                hoverColor: Colors.white,
                onTap: () {
                  if (suratController.index_terpilih != null) {
                    suratController.proses_print();
                  } else {
                    Toast(
                        "Peringatan",
        ...
        body: Container(
          ...
          child: Column(
            children: [
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: TextField(
                                  controller:
                                      suratController.searchController,
              ...
              Expanded(
                child: (suratController.data_surat_list.length > 0)
                    ? ListView.builder(
                        padding: const EdgeInsets.symmetric(
                            horizontal: 32, vertical: 24),
                        itemCount:
                            suratController.data_surat_list.length,
                        itemBuilder: (BuildContext context, int index) {
                          return SuratCard(index, pressEdit: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (_) => AddSuratScreen(
                                          true,
                                          data_edit: suratController
