          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              mutasibrgController.filter_tanggalController,
                          onSelectionChanged:
                              mutasibrgController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (mutasibrgController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (mutasibrgController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
