          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: SfDateRangePicker(
                          controller:
                              BelisparepartController.filter_tanggalController,
                          onSelectionChanged:
                              BelisparepartController.onSelectionChanged,
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () async {
                    if (BelisparepartController.isEnable_button) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: (BelisparepartController.isEnable_button)
                          ? HijauColor
                          : GreyColor,
