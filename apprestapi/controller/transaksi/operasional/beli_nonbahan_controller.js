...
///========================/// TRANSAKSI BELI NON BAHAN ///========================///
exports.belinonbahan_paginate = function (req, res) {
...
exports.count_belinonbahanpaginate = function (req, res) {
    var filter_cari = '%' + req.body.cari + '%';
...
exports.modalbelinonbahan = function (req, res) {
...
exports.hapusbelinonbahan = function (req, res) {
    var no_bukti = req.body.no_bukti;
...
exports.ambilbelinonbahandetail = function (req, res) {
    var nobukti = req.body.cari;
    // var filter_cari = '%'+req.body.cari+'%';
