...
\p{Yi}*/
    ...
    public function element_staticText($data)
    {
        ...
        $this->pointer[] = array(
            "type" => "MultiCell", "width" => $data->reportElement["width"], "height" => $height,
    ...
    public function element_image($data)
    {
        ...
        switch ($data[scaleImage]) {
            case "FillFrame":
                $this->pointer[] = array(
                    "type" => "Image", "path" => $imagepath, "x" => $data->reportElement["x"] + 0, "y" => $data->reportElement["y"] + 0, "width" => $data->reportElement["width"] + 0,
    ...
    public function element_crossTab($data)
    {
        ...
        */
        foreach ($data->columnGroup as $c => $cd) {
            ...
            $style = array(
                "colheaderalign" => $colheaderalign, "colheadervalign" => $colheadervalign, "colheaderbgcolor" => $colheaderbgcolor,
        ...
        foreach ($data->crosstabCell as $ce => $cecontent) {
            ...
            $style = array(
                "ceheaderalign" => $ceheaderalign, "ceheadervalign" => $ceheadervalign, "ceheaderbgcolor" => $ceheaderbgcolor,
        ...
        $this->pointer[] = array(
            "type" => "CrossTab", "x" => $x, "y" => $y, "width" => $ctwidth, "height" => $height, "dataset" => $dataset,
    ...
    {    //default line width=0.567(no detect line width)
        ...
        {
            $this->pointer[] = array(
                "type" => "Line", "x1" => $data->reportElement["x"] + 0, "y1" => $data->reportElement["y"] + 0,
        ...
        {
            $this->pointer[] = array(
                "type" => "Line", "x1" => $data->reportElement["x"], "y1" => $data->reportElement["y"],
    ...
    public function element_rectangle($data)
    {
        ...
        $border = array("LTRB" => array(
            'width' => $borderwidth, 'color' => $drawcolor, 'cap' => 'square',
        ...
        //        else
        $this->pointer[] = array(
            "type" => "RoundedRect", "x" => $data->reportElement["x"] + 0,
    ...
    public function element_textField($data)
    {
        ...
        switch ($data->textFieldExpression) {
            case 'new java.util.Date()':
                //### New: =>date("Y.m.d.",....
                $this->pointer[] = array(
                    "type" => "MultiCell", "width" => $data->reportElement["width"], "height" => $height, "txt" => date("Y-m-d H:i:s"), "border" => $border, "align" => $align, "fill" => $fill, "hidden_type" => "date", "soverflow" => $stretchoverflow, "poverflow" => $printoverflow, "link" => $data->hyperlinkReferenceExpression, "valign" => $valign,
                    "x" => $data->reportElement["x"] + 0, "y" => $data->reportElement["y"] + 0
                );
                //### End of modification				
                break;
            case '"Page "+$V{PAGE_NUMBER}+" of"':
                $this->pointer[] = array(
                    "type" => "MultiCell", "width" => $data->reportElement["width"], "height" => $height, "txt" => 'Page $this->PageNo() of', "border" => $border, "align" => $align, "fill" => $fill, "hidden_type" => "pageno", "soverflow" => $stretchoverflow, "poverflow" => $printoverflow, "link" => $data->hyperlinkReferenceExpression, "pattern" => $data["pattern"], "valign" => $valign,
                    "x" => $data->reportElement["x"] + 0, "y" => $data->reportElement["y"] + 0
                );
                break;
            case '$V{PAGE_NUMBER}':
                ...
                if (isset($data["evaluationTime"]) && $data["evaluationTime"] == "Report") {
                    $this->pointer[] = array(
                        "type" => "MultiCell", "width" => $data->reportElement["width"], "height" => $height, "txt" => '{{:ptp:}}', "border" => $border, "align" => $align, "fill" => $fill, "hidden_type" => "pageno", "soverflow" => $stretchoverflow, "poverflow" => $printoverflow, "link" => $data->hyperlinkReferenceExpression, "pattern" => $data["pattern"], "valign" => $valign,
                        "x" => $data->reportElement["x"] + 0, "y" => $data->reportElement["y"] + 0
                    );
                } else {
                    $this->pointer[] = array(
                        "type" => "MultiCell", "width" => $data->reportElement["width"], "height" => $height, "txt" => '$this->PageNo()', "border" => $border, "align" => $align, "fill" => $fill, "hidden_type" => "pageno", "soverflow" => $stretchoverflow, "poverflow" => $printoverflow, "link" => $data->hyperlinkReferenceExpression, "pattern" => $data["pattern"], "valign" => $valign,
                        "x" => $data->reportElement["x"] + 0, "y" => $data->reportElement["y"] + 0
                    );
                }
                break;
            case '" " + $V{PAGE_NUMBER}':
                $this->pointer[] = array(
                    "type" => "MultiCell", "width" => $data->reportElement["width"], "height" => $height, "txt" => ' {{:ptp:}}',
            ...
            default:
                ...
                $this->pointer[] = array(
                    "type" => "MultiCell", "width" => $data->reportElement["width"] + 0, "height" => $height + 0, "txt" => $data->textFieldExpression . "",
    ...
    public function element_subReport($data)
    {
        ...
        $this->pointer[] = array(
            "type" => "subreport", "x" => $data->reportElement["x"], "y" => $data->reportElement["y"],
    ...
    public function element_pieChart($data)
    {
        ...
        $this->pointer[] = array(
            'type' => 'PieChart', 'x' => $x, 'y' => $y, 'height' => $height, 'width' => $width, 'charttitle' => $charttitle,
    ...
    public function element_Chart($data, $type)
    {
        ...
        $this->pointer[] = array(
            'type' => $type, 'x' => $x, 'y' => $y, 'height' => $height, 'width' => $width, 'charttitle' => $charttitle,
            'chartsubtitle' => $chartsubtitle,
            'chartLegendPos' => $chartLegendPos, 'dataset' => $dataset, 'seriesexp' => $seriesexp,
    ...
    public function showLineChart($data, $y_axis)
    {
        ...
        $scalesetting = $scaleSettings = array(
            "XMargin" => 10, "YMargin" => 10, "Floating" => TRUE, "GridR" => 200, "GridG" => 200,
    ...
    public function showBarChart($data, $y_axis, $type = 'barChart')
    {
        ...
        if ($type == 'stackedBarChart')
            $scalesetting = array(
                "Floating" => TRUE, "GridR" => 200, "GridG" => 200, "GridB" => 200, "DrawSubTicks" => TRUE, "CycleBackground" => TRUE,
    ...
    public function columnFooter()
    {
        ...
        //$this->titlesummary=$this->arraycolumnHeader[0]["height"];
        //DWI EDIT
        $y = $this->maxpagey['page_' . ($this->pdf->getPage() - 1)];
        //print_r($this->arraytitle);die;
    ...
    public function summary($y)
    {
        ...
        // $currentPage = $this->pdf->GetPage(); //dwi
        $y = $y - 13; // dwi
    ...
    public function printlongtext($fontfamily, $fontstyle, $fontsize)
    {
        ...
        $this->pdf->MultiCell(
            ...
            $bltxt['ishtml'],
            $bltxt['autopadding'],
            $maxheight - $bltxt['height'],
            $bltxt['valign']
        );

        if ($this->pdf->balancetext != '') {
            $this->continuenextpageText = array(
                'width' => $bltxt["width"], 'height' => $bltxt["height"],
    ...
    public function detail()
    {
        ...
        if ($this->arraysqltable) {
            ...
            foreach ($this->arraysqltable as $row) {
                ...
                //echo "C";
                //begin page handling
                //echo "LOOP till ".$this->detailbandqty." ";
                for ($d = 0; $d < $this->detailbandqty; $d++) {
                    ...
                    //                    ";
                    //echo "C1 ";
                    //ini coding pindah halaman -> jika melebihi detailallowtill dsb
                        ...
                        switch ($out["hidden_type"]) {
                            case "field":
                                ...
                                $this->prepare_print_array = array(
                                    "type" => "MultiCell", "width" => $out["width"], "height" => $out["height"], "txt" => $out["txt"],
    ...
    public function display($arraydata, $y_axis = 0, $fielddata = false, $maxheight = 0)
    {
        ...
        if ($arraydata["type"] == "SetFont") {
            ...
            $this->pdf->Cell(
                $arraydata["width"],
                $arraydata["height"],
                $this->updatePageNo($arraydata["txt"]),
                $arraydata["border"],
                $arraydata["ln"],
                $arraydata["align"],
                $arraydata["fill"],
            ...
            $this->pdf->Rect(
                $arraydata["x"] + $this->arrayPageSetting["leftMargin"],
                $arraydata["y"] + $y_axis,
                $arraydata["width"],
                $arraydata["height"],
                $style,
            ...
            //$this->pdf->SetLineStyle($arraydata['border']);
            $this->pdf->Ellipse(
                $arraydata["x"] + $arraydata["width"] / 2 + $this->arrayPageSetting["leftMargin"],
                $arraydata["y"] + $y_axis + $arraydata["height"] / 2,
                $arraydata["width"] / 2,
                $arraydata["height"] / 2,
                0,
                0,
        ...
        if ($this->print_expression_result == true) {
            ...
            if ($arraydata["writeHTML"] == 1 && $this->pdflib == "TCPDF") {
                ...
                $this->pdf->MultiCell(
                    $arraydata["width"],
                    $arraydata["height"],
                    $this->formatText($txt, $arraydata["pattern"]),
                    $arraydata["border"],
                    $arraydata["align"],
                    $arraydata["fill"],
                    1,
                ...
                if ($this->pdf->balancetext != '') {
                    $this->continuenextpageText = array(
                        'width' => $arraydata["width"], 'height' => $arraydata["height"], 'txt' => $this->pdf->balancetext,
        ...
        if (sizeof($this->grouplist) > 0 && ($this->global_pointer > 0)) {
            ...
            foreach ($this->grouplist as $g) {
                ...
                if ($type == "header") {
                    ...
                    if (
                        $this->arraysqltable[$this->global_pointer][$g['headercontent'][0]["groupExpression"]] !=
